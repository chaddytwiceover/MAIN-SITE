...
const THEMES: Record<MusicId, Theme> = {
  ...
  hollow: {
    bpm: 100,
    steps: 16,
    bass: [41, 0, 48, 0, 45, 0, 48, 0, 40, 0, 47, 0, 43, 0, 47, 0],
    lead: [65, 69, 72, 69, 76, 72, 69, 65, 64, 67, 71, 67, 74, 71, 67, 64],
    harmony: [69, 0, 76, 0, 72, 0, 76, 0, 67, 0, 74, 0, 71, 0, 74, 0],
    bassType: "triangle",
    leadType: "triangle",
  },
  queen: {
    bpm: 80,
    steps: 16,
    bass: [36, 0, 43, 0, 48, 0, 43, 0, 38, 0, 45, 0, 50, 0, 45, 0],
    lead: [60, 64, 67, 72, 76, 72, 67, 64, 62, 65, 69, 74, 77, 74, 69, 65],
    spark: [0, 0, 84, 0, 88, 0, 84, 0, 0, 0, 86, 0, 89, 0, 86, 0],
    bassType: "sawtooth",
    leadType: "triangle",
  },
};
...
export function sfxPowerUp() {
  tone(440, 0.08, "triangle", 0.06, 0);
  tone(554, 0.08, "triangle", 0.06, 0.06);
  tone(659, 0.08, "triangle", 0.07, 0.12);
  tone(880, 0.18, "sine", 0.08, 0.18);
}

export function sfxFreeze() {
  tone(987, 0.12, "sine", 0.06, 0);
  tone(880, 0.14, "sine", 0.05, 0.08);
  tone(784, 0.18, "sine", 0.05, 0.16);
  tone(659, 0.25, "triangle", 0.04, 0.24);
}

export function sfxAlert() {
  tone(600, 0.07, "square", 0.05, 0);
  tone(800, 0.12, "square", 0.06, 0.08);
}
