/**
 * Social Links — Central data source
 *
 * Edit this file to update social links across the entire site.
 * Used by: Socials page, Contact page, Footer
 */
...
export const socialLinks: SocialLink[] = [
  {
    ...
    description: 'Code, repos, and open source stuff',
    iconPath:
  ...
  },
  {
    ...
    description: 'Quick takes and web dev thoughts',
    iconPath:
